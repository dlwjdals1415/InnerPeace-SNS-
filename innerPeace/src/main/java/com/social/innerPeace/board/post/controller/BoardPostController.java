...
public class BoardPostController {
    ...
    @GetMapping("board/post/detail/{postNo}")
    public String postdetail(Model model, @PathVariable Long postNo){
        log.info("call boarddetail");
        PosTListDTO dto = boardPostService.findByPostNo(postNo);
        if(dto == null){
    ...
    public String postwrite(WriteDTO dto) throws IOException {
